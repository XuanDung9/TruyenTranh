var Script = function (idtable) {
        ...
        jQuery('#' +idtable + ' .group-checkable').change(function () {
        ...
        jQuery('#' + idtable + '_wrapper .dataTables_filter input').addClass("input-medium"); // modify table search input
        jQuery('#' +idtable + '_wrapper .dataTables_length select').addClass("input-mini"); // modify table per page dropdown
...
function inittable(idtable) {
    ...
    $('#' + idtable).dataTable({
        ...
        "sPaginationType": "bootstrap",
        "oLanguage": {
            "sLengthMenu": "_MENU_ bản ghi cho mỗi trangs",
            "oPaginate": {
                "sPrevious": "Prev",
                "sNext": "Next"
            }
