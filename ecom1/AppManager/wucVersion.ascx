<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wucVersion.ascx.cs" Inherits="HamtruyenAdmin.wucVersion" %>
<div class="row-fluid" id="notification">
    <div class="span12">
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">Quản Lý phiên bản
            </li>
    ...
    <div class="span12">
        <div class="widget orange">
            <div class="widget-title">
                <h4><i class="icon-reorder"></i>Danh sách các phiên bản</h4>
                <span class="tools">
            ...
            <div class="widget-body" runat="server">
                <asp:Button ID="btnThemPhienBan" runat="server" CssClass="btn btn-primary" CommandName="ThemPhienBan" Text="Thêm Phiên bản" OnClick="btn_Them" />
                <div class="clearfix">
                </div>
...
<div class="row-fluid" id="edit_PhienBan" runat="server">
    <div class="span12">
        <div class="widget orange">
            <div class="widget-title">
                <h4><i class="icon-reorder"></i>Chỉnh sửa thông tin phiên bản</h4>
                <span class="tools">
                    <a href="javascript:;" class="icon-chevron-down"></a>
                    <a href="javascript:;" class="icon-remove"></a>
                </span>
